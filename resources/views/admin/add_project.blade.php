<x-layout>
    ...
    <div class="content-container text-center  px-10  mt-2">
        ...
        <form method="POST" class="w-4/5 mx-auto" action="" enctype="multipart/form-data">
            @csrf
            @method('POST')
            <div class="input_container flex space-x-4">
                ...
                <div class="flex-1">
                    ...
                    <input type="text" class="border border-gray-200 rounded p-2 w-full" name="cyles"
                        value="" />
                </div>
            ...
            <div class="input_container flex space-x-4">
                <div class="flex-1">
                    ...
                    <input type="date" class="border border-gray-200 rounded float-left p-2 w-4" name="end_date"
                        value="" />
